...
2. Installed extensions (Claude Code & Codex)
3. Logged into extensions
4. Created GitHub repository
5. Connected local project to GitHub
6. Created README.md
...
Solution: Used git pull origin main --rebase to sync changes

## 4. Learnings
- Learned Git & GitHub workflow
- Learned how to troubleshoot errors
- Learned how to use AI tools in development